...
const runStatsSchema = z.object({
  ...
  publicSelectionEligible: z.number().int().nonnegative().optional(),
  publicSelectionLowInformationFiltered: z.number().int().nonnegative().optional(),
  publicSelectionQualityFiltered: z.number().int().nonnegative().optional(),
  publicSelectionEventMerged: z.number().int().nonnegative().optional(),
  publicSelectionAdaptiveTarget: z.number().int().nonnegative().optional(),
  publicSelectionExpansionArticles: z.number().int().nonnegative().optional(),
