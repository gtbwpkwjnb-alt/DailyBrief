 ...
 */
const BASE = "https://reply-vc-90459984647.us-central1.run.app/v1/articles/leaderboard";
...
function isEnglish(e) {
    ...
    if (e.lang === "en" || e.lang === "zxx")
        return true;
    return false;
}
export async function fetchAttentionVc(sourceId, limit = 20) {
